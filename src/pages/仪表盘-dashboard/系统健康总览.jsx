...
export default function 1_系统健康总览() {
  const featureSlug = "系统健康总览"
    ...
    <ErrorBoundary>
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold">系统健康总览</h1>
            <p className="text-muted text-sm">实时展示关键服务的运行状态、在线设备总数、数据上链吞吐量 (tx/min) 和后端服务可用性 SLO 。</p>
          </div>
          <div className="flex items-center gap-2">
            ...
            <PermissionGate perm="系统健康总览:export"><button className="btn">导出</button></PermissionGate>
            <PermissionGate perm="系统健康总览:create"><button className="btn btn-primary" onClick={()=>setFormOpen(v=>!v)}>新增</button></PermissionGate>
          </div>
        </div>
