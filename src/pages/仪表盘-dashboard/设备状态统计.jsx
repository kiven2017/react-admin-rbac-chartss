...
export default function 1_设备状态统计() {
  const featureSlug = "设备状态统计"
    ...
    <ErrorBoundary>
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold">设备状态统计</h1>
            <p className="text-muted text-sm">以图表形式展示不同应用领域（如智慧农业、能源管理）的设备分布、健康状况（在线/离线/故障） 和固件版本分布。</p>
          </div>
          <div className="flex items-center gap-2">
            ...
            <PermissionGate perm="设备状态统计:export"><button className="btn">导出</button></PermissionGate>
            <PermissionGate perm="设备状态统计:create"><button className="btn btn-primary" onClick={()=>setFormOpen(v=>!v)}>新增</button></PermissionGate>
          </div>
        </div>
