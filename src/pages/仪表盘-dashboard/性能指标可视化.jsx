...
export default function 1_性能指标可视化() {
  const featureSlug = "性能指标可视化"
    ...
    <ErrorBoundary>
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold">性能指标可视化</h1>
            <p className="text-muted text-sm">CPU/内存使用率、API响应时间，支持自定义KPI阈值警报</p>
          </div>
          <div className="flex items-center gap-2">
            ...
            <PermissionGate perm="性能指标可视化:export"><button className="btn">导出</button></PermissionGate>
            <PermissionGate perm="性能指标可视化:create"><button className="btn btn-primary" onClick={()=>setFormOpen(v=>!v)}>新增</button></PermissionGate>
          </div>
        </div>
