  ...
  return (
    <div className='space-y-4'>
      <div className='flex items-center justify-between'>
        <div><h1 className='text-2xl font-semibold'>操作审计日志</h1><p className='text-muted text-sm'>所有与设备身份相关的操作（注册、更新、注销 等）都必须有不可篡改的链上或后台审计日志 。</p></div>
