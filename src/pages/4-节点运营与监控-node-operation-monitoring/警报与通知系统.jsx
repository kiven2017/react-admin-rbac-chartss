...
export default function 4_警报与通知系统() {
  const featureSlug = "警报与通知系统"
    ...
    <ErrorBoundary>
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold">警报与通知系统</h1>
            <p className="text-muted text-sm">集成邮件/SMS/Push，当健康指标异常时自动通知管理员</p>
          </div>
          <div className="flex items-center gap-2">
            ...
            <PermissionGate perm="警报与通知系统:export"><button className="btn">导出</button></PermissionGate>
            <PermissionGate perm="警报与通知系统:create"><button className="btn btn-primary" onClick={()=>setFormOpen(v=>!v)}>新增</button></PermissionGate>
          </div>
        </div>
