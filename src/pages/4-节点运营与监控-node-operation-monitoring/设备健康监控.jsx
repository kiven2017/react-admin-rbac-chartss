...
export default function 4_设备健康监控() {
    ...
    <ErrorBoundary>
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold">设备健康监控</h1>
            <p className="text-muted text-sm">实时监控单个设备的健康状况，包括网络连接状态（Wi-Fi, LTE-M, LoRaWAN ）、电池电量、信号强度和数据上报频率 。</p>
          </div>
          <div className="flex items-center gap-2">
            ...
            <PermissionGate perm="设备健康监控:export"><button className="btn">导出</button></PermissionGate>
            <PermissionGate perm="设备健康监控:create"><button className="btn btn-primary" onClick={()=>setFormOpen(v=>!v)}>新增</button></PermissionGate>
          </div>
        </div>
