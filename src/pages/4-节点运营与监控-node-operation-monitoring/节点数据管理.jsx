...
export default function 4_节点数据管理() {
    ...
    <ErrorBoundary>
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold">节点数据管理</h1>
            <p className="text-muted text-sm">提供数据浏览器功能，允许按设备 DID 或数据源查看原始和已处理的数据，便于调试和验证数据准确性 。</p>
          </div>
          <div className="flex items-center gap-2">
            ...
            <PermissionGate perm="节点数据管理:export"><button className="btn">导出</button></PermissionGate>
            <PermissionGate perm="节点数据管理:create"><button className="btn btn-primary" onClick={()=>setFormOpen(v=>!v)}>新增</button></PermissionGate>
          </div>
        </div>
