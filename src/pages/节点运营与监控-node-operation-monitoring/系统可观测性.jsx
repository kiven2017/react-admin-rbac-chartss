...
export default function 4_系统可观测性() {
    ...
    <ErrorBoundary>
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold">系统可观测性</h1>
            <p className="text-muted text-sm">集成日志、指标和链路追踪工具的访问入口。所有服务需暴露/metrics端点，并提供至少90天的历史数据查询 。</p>
          </div>
          <div className="flex items-center gap-2">
            ...
            <PermissionGate perm="系统可观测性:export"><button className="btn">导出</button></PermissionGate>
            <PermissionGate perm="系统可观测性:create"><button className="btn btn-primary" onClick={()=>setFormOpen(v=>!v)}>新增</button></PermissionGate>
          </div>
        </div>
