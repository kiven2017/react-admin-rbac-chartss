...
export default function 性能优化与集成确保可扩展性_性能监控() {
  const featureSlug = "性能监控"
    ...
    <ErrorBoundary>
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold">性能监控</h1>
          ...
          <div className="flex items-center gap-2">
            ...
            <PermissionGate perm="性能监控:export"><button className="btn">导出</button></PermissionGate>
            <PermissionGate perm="性能监控:create"><button className="btn btn-primary" onClick={()=>setFormOpen(v=>!v)}>新增</button></PermissionGate>
          </div>
        </div>
