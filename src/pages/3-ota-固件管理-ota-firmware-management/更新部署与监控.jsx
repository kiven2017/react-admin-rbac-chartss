...
export default function 3_更新部署与监控() {
  const featureSlug = "更新部署与监控"
    ...
    <ErrorBoundary>
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold">更新部署与监控</h1>
            <p className="text-muted text-sm">在审批通过后，管理员可以创建更新任务，选择目标设备并进行分批推送。实时监控 OTA 更新状态 ，包括已更新设备数量、失败设备列表及原因 。验收标准要求在推送后10分钟内能在后台看到设备状态更新 。</p>
          </div>
          <div className="flex items-center gap-2">
            ...
            <PermissionGate perm="更新部署与监控:export"><button className="btn">导出</button></PermissionGate>
            <PermissionGate perm="更新部署与监控:create"><button className="btn btn-primary" onClick={()=>setFormOpen(v=>!v)}>新增</button></PermissionGate>
          </div>
        </div>
