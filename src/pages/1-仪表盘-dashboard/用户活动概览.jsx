...
export default function 1_用户活动概览() {
  const featureSlug = "用户活动概览"
    ...
    <ErrorBoundary>
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold">用户活动概览</h1>
            <p className="text-muted text-sm">数据消费者活跃度、收入趋势图表</p>
          </div>
          <div className="flex items-center gap-2">
            ...
            <PermissionGate perm="用户活动概览:export"><button className="btn">导出</button></PermissionGate>
            <PermissionGate perm="用户活动概览:create"><button className="btn btn-primary" onClick={()=>setFormOpen(v=>!v)}>新增</button></PermissionGate>
          </div>
        </div>
